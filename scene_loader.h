...
// - Si le fichier est introuvable, affiche une erreur sur cerr
// - Lis ligne par ligne
// - Ignore les lignes vides et celles commençant par '#'
// - Parse "sphere x y z radius" → crée un Sphere avec make_shared
// - Parse "plane x y z  nx ny nz" → crée un Plane avec make_shared
// - Types inconnus → warning sur cerr, continue
